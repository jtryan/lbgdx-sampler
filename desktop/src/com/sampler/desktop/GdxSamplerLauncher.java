...
public class GdxSamplerLauncher extends JFrame {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                if (lwjglAWTCanvas != null) {
                    // stop will call dispose and stop libgdx application
                    lwjglAWTCanvas.stop();
                }
            }
        });
    ...
    private void createControlPanel() {
        ...
        c.gridx = 0; // column
        c.gridy = 0; // row
        c.fill = GridBagConstraints.VERTICAL;  // fill wetically
        c.weighty = 1; //weight used when adding to list
...
//        launchButton.setFont(LIST_FONT);
    ...
    private void launchSelectedSample() {
        ...
        if (sampleName == null || sampleName.isEmpty()) {
            System.out.printf("Sample name is empty cannot launch");
            return;
        }
